...
Like most of my projects, the reason I started was embarrassingly simple: I realized I didn’t actually know what a “programming language” was.
...
So I gave myself a goal that was intentionally small and honest: if I could build something that demystified compilers for me, I’d call it a win. Glitchy is the result.
...
- A syntax simple enough that I could focus on the compiler, not the language lawyering.
- A compiler pipeline that is readable, with logs that let you see your program move through stages.

The educational part mattered a lot. I didn’t want a compiler that worked only if you squinted at it. I wanted something a curious student (including future me) could actually trace. If your compiler is a black box, it teaches you the same thing your existing languages already taught you: nothing.

I also originally wanted Glitchy to be dynamically typed.

That desire did not survive contact with reality.
...
Still, I don’t regret it. Python is readable, and that mattered more than micro-optimizations. Glitchy was built to be understood, not to win benchmark competitions that nobody is running.
...
I’m intentionally keeping this section high-level because the writeup is supposed to be readable. The important part is that Glitchy is not “interpreting lines of code.” It builds structure first, checks that structure, then generates a lower-level program representation.

That pipeline was the point of the project.

## The Problem That Forced Glitchy to Grow Up

Here’s where my initial plan ran into a wall.

I wanted a dynamically typed language, but I also wanted to target LLVM IR.

If you don’t see the problem yet: LLVM is a statically typed backend. Every value has a type. LLVM wants you to commit.
...
I tried. I really did. I spent weeks trying to make boxing clean and ergonomic, and I got deep enough into it that I started dreaming in “box, unbox, branch on tag.” At some point I had to admit what was happening: I wasn’t learning “compiler fundamentals” anymore, I was building a runtime system.
...
This feature also pushed me to design the compiler in a way where the AST was a real first-class representation. If you can’t confidently manipulate your program structure, you don’t really “own” the compiler.

## What I Learned

Glitchy taught me more than I expected, mostly because it forced me to stop hand-waving:
...
Most importantly: I came out of it with intuition I didn’t have before. I can read about compilers now without feeling like I’m reading mythology.