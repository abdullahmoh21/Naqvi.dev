...
A month ago I sat down to build an in-memory key-value store like Redis, in C, from scratch. Two restrictions: no AI, no external dependencies. (More on why I wanted to do this [here](/blog/languages-i-was-scared-of).)
